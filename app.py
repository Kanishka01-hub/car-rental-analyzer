...
st.sidebar.markdown(" [View GitHub
Repo](https://github.com/Hiteshyc/car_rental_feedback_analyzer_watson.ai)")
...
# Watson sentiment (cached) @st.cache_data(show_spinner=False)
...
"<a href='https://github.com/Hiteshyc/car_rental_feedback_analyzer_watson.ai' target='_blank'>GitHub
Repo</a>"
"</div>",
unsafe_allow_html=True,
)
